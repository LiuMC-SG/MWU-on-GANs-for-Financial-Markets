...
from gan_model import GANExpert  # noqa: E402
...
def main():
    ...
    ap.add_argument("--base-channels-G", type=int, default=16)
    ap.add_argument("--base-channels-D", type=int, default=64)
    ...
    last_model: Optional[GANExpert] = None
